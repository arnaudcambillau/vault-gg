 ...
 */
final class Version20251201153125 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, rawg_id INT NOT NULL, name VARCHAR(255) NOT NULL, background_image VARCHAR(500) DEFAULT NULL, released DATE DEFAULT NULL, rating DOUBLE PRECISION DEFAULT NULL, genres JSON DEFAULT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE user_game (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(50) NOT NULL, is_favorite TINYINT NOT NULL, added_at DATETIME NOT NULL, user_id INT NOT NULL, game_id INT NOT NULL, INDEX IDX_59AA7D45A76ED395 (user_id), INDEX IDX_59AA7D45E48FD905 (game_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
